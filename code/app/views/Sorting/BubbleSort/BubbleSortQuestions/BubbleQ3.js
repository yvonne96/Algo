...
export class BubbleQ3 extends Component {
  constructor(props) {
    super(props);
    this.height = 70;
    this.width = 500;
  ...
  createRectangles() {
    ...
    this.numbers[2][0].style("fill", "grey");
    this.numbers[3][0].style("fill", "grey");
  }
  ...
  render() {
    return (
      <div>
        <p>Which numbers will be swapped next?</p>
...
export default mapStateToProps(BubbleQ3);
