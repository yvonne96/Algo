...
export class BubbleQ1 extends Component {
  constructor(props) {
    super(props);
    this.height = 70;
    this.width = 500;
  ...
  render() {
    return (
      <div>
        <p>How many swaps are needed to sort the numbers?</p>
...
export default mapStateToProps(BubbleQ1);
