...
export class InsertionQ3 extends Component {
  constructor(props) {
    super(props);
    this.height = 70;
    this.width = 600;
  ...
  render() {
    return (
      <div>
        <p>How many more insertions are needed to sort this list?</p>
...
export default mapStateToProps(InsertionQ3);
