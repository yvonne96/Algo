...
export class InsertionQ1 extends Component {
  constructor(props) {
    super(props);
    this.height = 70;
    this.width = 500;
  ...
  checkAnswer() {
    this.checked = true;
    if (document.getElementById("answer").value == "78") {
      this.correct = true;
    }
    this.forceUpdate();
  }
...
export default mapStateToProps(InsertionQ1);
