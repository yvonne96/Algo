      ...
      <div className="BubbleSortHome">
        ...
        <div className="content">
          ...
          <div className="contain">
            ...
            <p>
              ...
              sorted. The algorithm, which is a comparison sort, is named for
              the way smaller or larger elements "bubble" to the top of the
              list. Although the algorithm is simple, it is too slow and
              impractical for most problems even when compared to insertion
              sort. It can be practical if the input is usually in sorted order
              but may occasionally have some out-of-order elements nearly in
              position.
            </p>
          </div>
        </div>
        <div className="content">
          ...
          <div className="contain">
            ...
            <p>
              <b>Worst Case Performance:</b>O(n<sup>2</sup>)
            </p>
            <p>
              <b>Best Case Performance:</b>O(n)
            </p>
            <p>
              <b>Average Case Performance:</b>O(n<sup>2</sup>)
            </p>
          </div>
        </div>
        <div className="content">
          ...
          <div className="contain">
            ...
            <p>
              ...
              step, elements written in bold are being compared. Three passes
              will be required.
            </p>
            <p>
              <b>First Pass:</b>
